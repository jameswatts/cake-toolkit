<?php
/**
 * Base class for a CSS declaration.
 *
 * PHP 5
 *
...
/**
 * Class representing a CSS declaration.
 *
 * @package       Ctk.Factory
 */
class CssDeclaration extends CssBlock {
 ...
 */
	protected $_template = 'declaration';
 ...
 */
	protected $_nodeType = 'declaration';
 ...
 */
	protected $_limitParent = array('CssRule');
