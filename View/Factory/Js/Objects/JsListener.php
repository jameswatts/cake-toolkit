<?php
/**
 * Base class for a JavaScript event listener.
 *
 * PHP 5
 *
...
/**
 * Class representing a JavaScript event listener.
 *
 * @package       Ctk.Factory
 */
class JsListener extends JsEvent {
