<?php
/**
 * Base class for a dynamic JavaScript callback.
 *
 * PHP 5
 *
...
/**
 * Class representing a dynamic JavaScript callback.
 *
 * @package       Ctk.Factory
 */
class JsCallback extends JsEvent {
