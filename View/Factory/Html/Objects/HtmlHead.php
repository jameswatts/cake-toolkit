<?php
/**
 * HTML object for the HEAD element.
 *
 * PHP 5
 *
...
/**
 * Creates an object representing a HEAD element in HTML.
 *
 * @package       Ctk.Factory
 */
 ...
 */
	protected $_limitChildren = array('HtmlBase', 'HtmlCommand', 'HtmlLink', 'HtmlMeta', 'HtmlNoscript', 'HtmlScript', 'HtmlStyle', 'HtmlTitle');
