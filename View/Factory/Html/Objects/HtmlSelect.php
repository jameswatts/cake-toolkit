<?php
/**
 * HTML object for the SELECT element.
 *
 * PHP 5
 *
...
/**
 * Creates an object representing a SELECT element in HTML.
 *
 * @package       Ctk.Factory
 */
 ...
 */
	protected $_limitChildren = array('HtmlOptgroup', 'HtmlOption');
}
