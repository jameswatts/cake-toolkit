<?php
/**
 * Base HTML object for the H1-H6 elements.
 *
 * PHP 5
 *
...
/**
 * Base object representing a H1-H6 element in HTML.
 *
 * @package       Ctk.Factory
 */
abstract class HtmlH extends HtmlElement {
